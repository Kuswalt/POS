...
(20, 100, '2024-11-18 19:35:01.000000', 0, 'Beef Patty', 'pieces'),
...
(33, 30, '2024-11-18 18:48:25.000000', 0, 'Chocolate', 'kilograms'),
...
(51, 'Blueberry Cheesecake', 179, 'Chocolate Series', 0x313733313932373538315f6c6f676f2e706e67, 'base-size'),
...
INSERT INTO `product_ingredients` (`product_ingredient_id`, `product_id`, `inventory_id`, `ingredient_name`, `quantity_needed`) VALUES
...
--
ALTER TABLE `inventory`
  MODIFY `inventory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `product_ingredients`
  MODIFY `product_ingredient_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=163;
